...
**Type Mismatch Error**
```
COALESCE types xid8 and integer cannot be matched
```
- This indicates a PostgreSQL version compatibility issue
- Ensure you're using a compatible PostgreSQL version
