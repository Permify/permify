...
<Note>
This is a <strong>Permify Cloud</strong> feature. To get more information, [schedule a call with an expert](https://www.permify.co/book-demo).
</Note>
...
```bash
permify-sync apply -f ./my_postgres_instance.yaml
```
