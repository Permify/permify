...
<Note>If you're interested in leveraging Permify Cloud for your authorization needs, we invite you to join our [early access program](https://www.permify.co/book-demo). By contacting us, you can get a personalized setup and dedicated support to get started with Permify Cloud.</Note>
...
One of the best practices to manage schema changes is setting up a central git repository that stores the schema YAML file. 
