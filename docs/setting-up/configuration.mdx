...
| database-max-connections                   | PERMIFY_DATABASE_MAX_CONNS                   | int      |
...
| database-min-connections                   | PERMIFY_DATABASE_MIN_CONNS                   | int      |
...
| database-max-connection-lifetime-jitter    | PERMIFY_DATABASE_MAX_CONN_LIFETIME_JITTER    | duration |
