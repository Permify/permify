...
// Validate checks the field values on SchemaPartialWriteRequestEntities with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *SchemaPartialWriteRequestEntities) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SchemaPartialWriteRequestEntities
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// SchemaPartialWriteRequestEntitiesMultiError, or nil if none found.
func (m *SchemaPartialWriteRequestEntities) ValidateAll() error {
	return m.validate(true)
}

func (m *SchemaPartialWriteRequestEntities) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SchemaPartialWriteRequestEntitiesMultiError(errors)
	}

	return nil
}

// SchemaPartialWriteRequestEntitiesMultiError is an error wrapping multiple
// validation errors returned by
// SchemaPartialWriteRequestEntities.ValidateAll() if the designated
// constraints aren't met.
type SchemaPartialWriteRequestEntitiesMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SchemaPartialWriteRequestEntitiesMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SchemaPartialWriteRequestEntitiesMultiError) AllErrors() []error { return m }

// SchemaPartialWriteRequestEntitiesValidationError is the validation error
// returned by SchemaPartialWriteRequestEntities.Validate if the designated
// constraints aren't met.
type SchemaPartialWriteRequestEntitiesValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SchemaPartialWriteRequestEntitiesValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SchemaPartialWriteRequestEntitiesValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SchemaPartialWriteRequestEntitiesValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SchemaPartialWriteRequestEntitiesValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SchemaPartialWriteRequestEntitiesValidationError) ErrorName() string {
	return "SchemaPartialWriteRequestEntitiesValidationError"
}

// Error satisfies the builtin error interface
func (e SchemaPartialWriteRequestEntitiesValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSchemaPartialWriteRequestEntities.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SchemaPartialWriteRequestEntitiesValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SchemaPartialWriteRequestEntitiesValidationError{}
...
func (m *SchemaPartialWriteResponse) validate(all bool) error {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SchemaPartialWriteResponseValidationError{
					field:  "Schema",
					reason: "embedded message failed validation",
					cause:  err,
				})
