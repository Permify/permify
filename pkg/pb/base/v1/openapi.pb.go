...
const file_base_v1_openapi_proto_rawDesc = "" +
	"\n" +
	"\x15base/v1/openapi.proto\x12\abase.v1\x1a.protoc-gen-openapiv2/options/annotations.protoB\xfe\x03\x92A\xf0\x02\x12\xa1\x02\n" +
	...
	"\x10AGPL-3.0 license\x126https://github.com/Permify/permify/blob/master/LICENSE2\vv1.6.6-jb.5*\x01\x022\x10application/json:\x10application/jsonZ#\n" +
	"!\n" +
	"\n" +
