...
type Operation struct {
	...
	RelationshipsWrite []string `protobuf:"bytes,1,rep,name=relationships_write,json=relationshipsWrite,proto3" json:"relationships_write,omitempty"`
	// 'relationships_delete' is a repeated string field for storing relationship keys
	// that are to be deleted or removed.
	RelationshipsDelete []string `protobuf:"bytes,2,rep,name=relationships_delete,json=relationshipsDelete,proto3" json:"relationships_delete,omitempty"`
	// 'attributes_write' is a repeated string field for storing attribute keys
	// that are to be written or created.
	AttributesWrite []string `protobuf:"bytes,3,rep,name=attributes_write,json=attributesWrite,proto3" json:"attributes_write,omitempty"`
	// 'attributes_delete' is a repeated string field for storing attribute keys
	// that are to be deleted or removed.
	AttributesDelete []string `protobuf:"bytes,4,rep,name=attributes_delete,json=attributesDelete,proto3" json:"attributes_delete,omitempty"`
}
...
var file_base_v1_base_proto_rawDesc = []byte{
	...
	,
	...
	,
