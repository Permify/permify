...
type PermissionClient interface {
	...
	BulkCheck(ctx context.Context, in *PermissionBulkCheckRequest, opts ...grpc.CallOption) (*PermissionBulkCheckResponse, error)
...
func (c *permissionClient) BulkCheck(ctx context.Context, in *PermissionBulkCheckRequest, opts ...grpc.CallOption) (*PermissionBulkCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PermissionBulkCheckResponse)
...
type PermissionServer interface {
	...
	// and returns a PermissionBulkCheckResponse with results for each request.
	// Maximum 100 requests can be processed in a single bulk operation.
	BulkCheck(context.Context, *PermissionBulkCheckRequest) (*PermissionBulkCheckResponse, error)
	// Expand method receives a PermissionExpandRequest and returns a PermissionExpandResponse.
	// It expands relationships according to the schema provided.
...
func (UnimplementedPermissionServer) BulkCheck(context.Context, *PermissionBulkCheckRequest) (*PermissionBulkCheckResponse, error) {
...
func _Permission_BulkCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PermissionBulkCheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServer).BulkCheck(ctx, req.(*PermissionBulkCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
const (
	SharedSchema_Write_FullMethodName  = "/base.v1.SharedSchema/Write"
	SharedSchema_Read_FullMethodName   = "/base.v1.SharedSchema/Read"
	SharedSchema_Assign_FullMethodName = "/base.v1.SharedSchema/Assign"
	SharedSchema_List_FullMethodName   = "/base.v1.SharedSchema/List"
)

// SharedSchemaClient is the client API for SharedSchema service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type SharedSchemaClient interface {
	// Write creates or updates a shared schema by its ID.
	Write(ctx context.Context, in *SharedSchemaWriteRequest, opts ...grpc.CallOption) (*SharedSchemaWriteResponse, error)
	// Read reads a shared schema by its ID and optional version.
	Read(ctx context.Context, in *SharedSchemaReadRequest, opts ...grpc.CallOption) (*SharedSchemaReadResponse, error)
	// Assign links one or more tenants to a shared schema.
	Assign(ctx context.Context, in *SharedSchemaAssignRequest, opts ...grpc.CallOption) (*SharedSchemaAssignResponse, error)
	// List lists all shared schemas with pagination.
	List(ctx context.Context, in *SharedSchemaListRequest, opts ...grpc.CallOption) (*SharedSchemaListResponse, error)
}

type sharedSchemaClient struct {
	cc grpc.ClientConnInterface
}

func NewSharedSchemaClient(cc grpc.ClientConnInterface) SharedSchemaClient {
	return &sharedSchemaClient{cc}
}

func (c *sharedSchemaClient) Write(ctx context.Context, in *SharedSchemaWriteRequest, opts ...grpc.CallOption) (*SharedSchemaWriteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SharedSchemaWriteResponse)
	err := c.cc.Invoke(ctx, SharedSchema_Write_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sharedSchemaClient) Read(ctx context.Context, in *SharedSchemaReadRequest, opts ...grpc.CallOption) (*SharedSchemaReadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SharedSchemaReadResponse)
	err := c.cc.Invoke(ctx, SharedSchema_Read_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sharedSchemaClient) Assign(ctx context.Context, in *SharedSchemaAssignRequest, opts ...grpc.CallOption) (*SharedSchemaAssignResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SharedSchemaAssignResponse)
	err := c.cc.Invoke(ctx, SharedSchema_Assign_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sharedSchemaClient) List(ctx context.Context, in *SharedSchemaListRequest, opts ...grpc.CallOption) (*SharedSchemaListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SharedSchemaListResponse)
	err := c.cc.Invoke(ctx, SharedSchema_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// SharedSchemaServer is the server API for SharedSchema service.
// All implementations must embed UnimplementedSharedSchemaServer
// for forward compatibility.
type SharedSchemaServer interface {
	// Write creates or updates a shared schema by its ID.
	Write(context.Context, *SharedSchemaWriteRequest) (*SharedSchemaWriteResponse, error)
	// Read reads a shared schema by its ID and optional version.
	Read(context.Context, *SharedSchemaReadRequest) (*SharedSchemaReadResponse, error)
	// Assign links one or more tenants to a shared schema.
	Assign(context.Context, *SharedSchemaAssignRequest) (*SharedSchemaAssignResponse, error)
	// List lists all shared schemas with pagination.
	List(context.Context, *SharedSchemaListRequest) (*SharedSchemaListResponse, error)
	mustEmbedUnimplementedSharedSchemaServer()
}

// UnimplementedSharedSchemaServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedSharedSchemaServer struct{}

func (UnimplementedSharedSchemaServer) Write(context.Context, *SharedSchemaWriteRequest) (*SharedSchemaWriteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Write not implemented")
}
func (UnimplementedSharedSchemaServer) Read(context.Context, *SharedSchemaReadRequest) (*SharedSchemaReadResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Read not implemented")
}
func (UnimplementedSharedSchemaServer) Assign(context.Context, *SharedSchemaAssignRequest) (*SharedSchemaAssignResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Assign not implemented")
}
func (UnimplementedSharedSchemaServer) List(context.Context, *SharedSchemaListRequest) (*SharedSchemaListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedSharedSchemaServer) mustEmbedUnimplementedSharedSchemaServer() {}
func (UnimplementedSharedSchemaServer) testEmbeddedByValue()                      {}

// UnsafeSharedSchemaServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to SharedSchemaServer will
// result in compilation errors.
type UnsafeSharedSchemaServer interface {
	mustEmbedUnimplementedSharedSchemaServer()
}

func RegisterSharedSchemaServer(s grpc.ServiceRegistrar, srv SharedSchemaServer) {
	// If the following call pancis, it indicates UnimplementedSharedSchemaServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&SharedSchema_ServiceDesc, srv)
}

func _SharedSchema_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SharedSchemaWriteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SharedSchemaServer).Write(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SharedSchema_Write_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SharedSchemaServer).Write(ctx, req.(*SharedSchemaWriteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SharedSchema_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SharedSchemaReadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SharedSchemaServer).Read(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SharedSchema_Read_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SharedSchemaServer).Read(ctx, req.(*SharedSchemaReadRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SharedSchema_Assign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SharedSchemaAssignRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SharedSchemaServer).Assign(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SharedSchema_Assign_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SharedSchemaServer).Assign(ctx, req.(*SharedSchemaAssignRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SharedSchema_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SharedSchemaListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SharedSchemaServer).List(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SharedSchema_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SharedSchemaServer).List(ctx, req.(*SharedSchemaListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// SharedSchema_ServiceDesc is the grpc.ServiceDesc for SharedSchema service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var SharedSchema_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "base.v1.SharedSchema",
	HandlerType: (*SharedSchemaServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Write",
			Handler:    _SharedSchema_Write_Handler,
		},
		{
			MethodName: "Read",
			Handler:    _SharedSchema_Read_Handler,
		},
		{
			MethodName: "Assign",
			Handler:    _SharedSchema_Assign_Handler,
		},
		{
			MethodName: "List",
			Handler:    _SharedSchema_List_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "base/v1/service.proto",
