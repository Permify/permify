...
type ExpandTreeNode struct {
	...
	Nodes     []*Expand                `protobuf:"bytes,2,rep,name=nodes,proto3" json:"nodes,omitempty"`
}
...
func (x *ExpandTreeNode) GetNodes() []*Expand {
	if x != nil {
		return x.Nodes
	}
	return nil
...
type Expand struct {
	...
	Expanded *EntityAndRelation `protobuf:"bytes,1,opt,name=expanded,proto3" json:"expanded,omitempty"`
	// Types that are assignable to NodeType:
	//	*Expand_Expand
	//	*Expand_Subjects
	NodeType isExpand_NodeType `protobuf_oneof:"node_type"`
}
...
func (x *Expand) GetExpanded() *EntityAndRelation {
	if x != nil {
		return x.Expanded
	}
	return nil
...
func (m *Expand) GetNodeType() isExpand_NodeType {
	if m != nil {
		return m.NodeType
	}
	return nil
...
func (x *Expand) GetExpand() *ExpandTreeNode {
	if x, ok := x.GetNodeType().(*Expand_Expand); ok {
		return x.Expand
	}
	return nil
}

func (x *Expand) GetSubjects() *Subjects {
	if x, ok := x.GetNodeType().(*Expand_Subjects); ok {
		return x.Subjects
	}
	return nil
}

type isExpand_NodeType interface {
	isExpand_NodeType()
}
...
type Expand_Subjects struct {
	Subjects *Subjects `protobuf:"bytes,3,opt,name=subjects,proto3,oneof"`
}

func (*Expand_Expand) isExpand_NodeType() {}

func (*Expand_Subjects) isExpand_NodeType() {}
...
var file_tuple_proto_rawDesc = []byte{
	...
	,
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x42, 0x10, 0x5a, 0x0e, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62,
...
var file_tuple_proto_depIdxs = []int32{
	...
	9,  // 6: ExpandTreeNode.nodes:type_name -> Expand
	3,  // 7: Expand.expanded:type_name -> EntityAndRelation
	8,  // 8: Expand.expand:type_name -> ExpandTreeNode
	10, // 9: Expand.subjects:type_name -> Subjects
