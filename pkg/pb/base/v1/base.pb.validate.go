...
// Validate checks the field values on NamedArgument with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *NamedArgument) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on NamedArgument with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in NamedArgumentMultiError, or
// nil if none found.
func (m *NamedArgument) ValidateAll() error {
	return m.validate(true)
}

func (m *NamedArgument) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(m.GetName()) > 64 {
		err := NamedArgumentValidationError{
			field:  "Name",
	...
	if !_NamedArgument_Name_Pattern.MatchString(m.GetName()) {
		err := NamedArgumentValidationError{
			field:  "Name",
	...
	if len(errors) > 0 {
		return NamedArgumentMultiError(errors)
	}

	return nil
}

// NamedArgumentMultiError is an error wrapping multiple validation errors
// returned by NamedArgument.ValidateAll() if the designated constraints
// aren't met.
type NamedArgumentMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m NamedArgumentMultiError) Error() string {
...
func (m NamedArgumentMultiError) AllErrors() []error { return m }

// NamedArgumentValidationError is the validation error returned by
// NamedArgument.Validate if the designated constraints aren't met.
type NamedArgumentValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e NamedArgumentValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e NamedArgumentValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e NamedArgumentValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e NamedArgumentValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e NamedArgumentValidationError) ErrorName() string { return "NamedArgumentValidationError" }

// Error satisfies the builtin error interface
func (e NamedArgumentValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = NamedArgumentValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = NamedArgumentValidationError{}

var _NamedArgument_Name_Pattern = regexp.MustCompile("^[a-zA-Z_]{1,64}$")
