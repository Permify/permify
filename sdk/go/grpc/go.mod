...
require (
	buf.build/gen/go/permifyco/permify/protocolbuffers/go v1.35.1-20240930153438-5bdb051ac145.1
	github.com/Permify/permify-go v0.4.9
	google.golang.org/grpc v1.67.1
)

require (
	buf.build/gen/go/envoyproxy/protoc-gen-validate/protocolbuffers/go v1.35.1-20221025150516-6607b10f00ed.1 // indirect
