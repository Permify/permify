...
func (r *relationshipRoutes) write(c echo.Context) (err error) {
	...
	err = r.service.WriteRelationship(context.Background(), []entities.RelationTuple{{Entity: request.Body.Namespace, ObjectID: request.Body.ObjectID, Relation: request.Body.Relation, UsersetEntity: request.Body.UsersetNamespace, UsersetObjectID: request.Body.UsersetObjectID, UsersetRelation: request.Body.UsersetRelation, Type: "custom"}})
	if err != nil {
...
func (r *relationshipRoutes) delete(c echo.Context) (err error) {
	...
	err = r.service.DeleteRelationship(context.Background(), []entities.RelationTuple{{Entity: request.Body.Namespace, ObjectID: request.Body.ObjectID, Relation: request.Body.Relation, UsersetEntity: request.Body.UsersetNamespace, UsersetObjectID: request.Body.UsersetObjectID, UsersetRelation: request.Body.UsersetRelation}})
	if err != nil {
		return echo.ErrInternalServerError
	}
