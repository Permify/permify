...
func (r *RelationshipWriterWithCircuitBreaker) WriteRelationships(ctx context.Context, tenantID string, collection database.ITupleCollection) (token.EncodedSnapToken, error) {
