FROM golang:1.26.3-alpine@sha256:91eda9776261207ea25fd06b5b7fed8d397dd2c0a283e77f2ab6e91bfa71079d AS permify-builder
WORKDIR /go/src/app
...
FROM golang:1.26.3-alpine@sha256:91eda9776261207ea25fd06b5b7fed8d397dd2c0a283e77f2ab6e91bfa71079d AS health-probe-builder
WORKDIR /go/src/app
RUN apk update && apk add --no-cache git
