FROM golang:1.26.4-alpine@sha256:a6a091eac01ceac4b97496fe2957a49b6cdd83365337d5f46f6f73710424e805 AS permify-builder
WORKDIR /go/src/app
...
FROM golang:1.26.4-alpine@sha256:a6a091eac01ceac4b97496fe2957a49b6cdd83365337d5f46f6f73710424e805 AS health-probe-builder
WORKDIR /go/src/app
RUN apk update && apk add --no-cache git
